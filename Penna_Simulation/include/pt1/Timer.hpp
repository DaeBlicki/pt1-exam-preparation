/*
 * Timer class in the pt1 utlity library
 * used to measuring code, get min, max and mean time of the time measurement
 * The measured time is guaranteed to be correct 
 */
